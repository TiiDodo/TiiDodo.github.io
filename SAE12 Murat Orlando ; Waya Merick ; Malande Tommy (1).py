...
#Pour pouvoir utiliser ce script, il faut télécharger plusieurs paquets.
#Comme psutils, netstat, socket...
#Pour installer un paquet il faut taper la commande : apt install "nom du paque"
...
ipConnu = ['www.google.com', 'www.cisco.com']

for f in range(2):
    try:
        requete = os.system("ping -c 2 "+ipConnu[f])
        if requete==0:
            print("La résolution DNS "+ipConnu[f]+" fonctionne\n\n")
        else:
            print("La résolution DNS "+ipConnu[f]+" ne fonctionne pas\n\n")
    except:
        print("erreur")
